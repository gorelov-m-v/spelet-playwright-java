...
import test.framework.device.DeviceProvider;
import test.pages.MainPage;
import test.pages.CasinoPage;
import test.pages.components.FilterDrawerComponent;
import test.pages.components.AuthModalComponent;
